...
namespace ClipboardCanvas.Helpers.SafetyHelpers
{
    ...
    {
        public static readonly SafeWrapperResult S_SUCCESS = new SafeWrapperResult(OperationErrorCode.Success, "Operation completed successfully.");

        public static readonly SafeWrapperResult S_CANCEL = new SafeWrapperResult(OperationErrorCode.Cancelled, "The operation was canceled.");

        public static readonly SafeWrapperResult S_UNKNOWN_FAIL = new SafeWrapperResult(OperationErrorCode.UnknownFailed, new Exception(), "An unknown error occurred.");
